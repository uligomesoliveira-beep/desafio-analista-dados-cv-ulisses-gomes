...
Bem-vindo ao desafio técnico para a vaga de Analista de Dados do Escritório de Monitoramento de Projetos e Metas da Secretaria da Casa Civil.
...
- Tutorial para acessar dados no BigQuery, desde a criação da conta no GCP até consultar os dados utilizando SQL e Python: [Como acessar dados no BigQuery](https://basedosdados.org/docs/access_data_bq)
...
Se tiver alguma dúvida ou precisar de esclarecimentos adicionais sobre o desafio, entre em contato pelo email empm.cvl@prefeitura.rio.
